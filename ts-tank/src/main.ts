const el = document.querySelector<HTMLCanvasElement>('#canvas')!//加！号表明一定存在
...
// #画个三角形（多边形也可以这样画）
// app.beginPath()//开始画画
// app.moveTo(el.width/2,10)//画笔起点
// app.lineTo(el.width,250)
// app.lineTo(10,250)
// app.closePath()//起点和结束点闭合
// app.strokeStyle='#F47C7C'//边线的颜色
// app.lineWidth=2//线的粗细
// app.stroke()//画线



// // #定义一个渐变色
// const gradient = app.createLinearGradient(0,0,300,300)//渐变的起点和终点
...
// app.lineJoin ='round'//拐角类型
// app.lineWidth = 20//线的粗细
...
//   //绘制图片
//   // app.drawImage(img,0,50,100,100)//图片绘制到0，50的位置，缩小到100*100
